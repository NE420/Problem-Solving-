...
void DFS(int x,int y, vector<vector<char>>& adj_list, vector<vector<bool>>& visited)
{
	visited[x][y] = true;
...
int main()
{
	...
	while (cin >> n)
	{
		...
		cout<< "Image number " << counter <<  " contains " << ans << " war eagles.\n";
